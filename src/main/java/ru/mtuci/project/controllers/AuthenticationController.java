...
import ru.mtuci.project.models.AuthenticationResponse;
import ru.mtuci.project.repositories.UserRepository;
import ru.mtuci.project.requests.AuthenticationRequest;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthenticationRequest request) {
        try {
            ...
            String token = jwtTokenProvider.generateToken(login, user.getRole().getGrantedAuthorities());
